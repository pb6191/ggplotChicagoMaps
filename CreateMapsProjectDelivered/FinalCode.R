...
zipCode_sf <- st_read("C:/Users/PC-P14s/Desktop/createMaps/Boundaries - ZIP Codes.geojson")
...
chicagoBoundary_sf <- st_read("C:/Users/PC-P14s/Desktop/createMaps/Boundaries - City.geojson")
